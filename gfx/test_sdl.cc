...
void waitAMoment()
{
    const int nWaitInNanoSec = 100000000;
...
std::string getKey()
{
    ...
    while( quit == 0)
    {
        int nMoreEvents = SDL_PollEvent( &event );
        if (nMoreEvents == 0)
        {
            // there are no event, wait a moment
            waitAMoment();
        }
        else
        {
            // Handle Event
            // t_print("Event.type %d\n", event.type);
            switch( event.type )
            {
            case SDL_QUIT:
                quit = 1;
            ...
            case SDL_KEYDOWN:
                ...
                {
                    t_print("SDL KEY:Quit\n");
                    quit = 1;
                }
                else if (event.key.keysym.sym == SDLK_RETURN)
                {
                    t_print("SDL KEY:Return\n");
                }
                else
                {
                    t_print("SDL unbekannte Taste\n");
                }                
                bKeyDown = true;
                break;
            }
    ...
    while( bKeyDown && SDL_PollEvent( &event ) == 0 )
    {
        switch( event.type )
        {
        case SDL_KEYUP:
...
// use getKey() std::string getFile()
// use getKey() {
// use getKey()     std::string aBackStr;
// use getKey()     
// use getKey()     SDL_Event event;
// use getKey()     // SDL_EventFilter aFilter = SDL_GetEventFilter();
// use getKey() 
// use getKey()     int quit = 0;
// use getKey()     // Event-Handling
// use getKey()     int nWaitInNanoSec = 100000000;
// use getKey()     // int nHandleEvents = 3;
// use getKey()     // int nDontHandleAnEvent = 0;
// use getKey() 
// use getKey()     int nWaitKeyEndprell = 0;
// use getKey()     while( quit == 0)
// use getKey()     {    
// use getKey()         struct timespec delay;
// use getKey()         delay.tv_sec = 0;
// use getKey()         delay.tv_nsec = nWaitInNanoSec;
// use getKey()         
// use getKey()         nanosleep(&delay, 0); // tenth second
// use getKey()         do
// use getKey()         {
// use getKey()             // bHandleEvent = false;
// use getKey()             
// use getKey()             switch( event.type )
// use getKey()             {
// use getKey()             case SDL_QUIT:
// use getKey()                 quit = 1;
// use getKey()                 break;
// use getKey()             case SDL_KEYUP:
// use getKey()                 nWaitKeyEndprell = 0;
// use getKey()                 break;
// use getKey()             case SDL_KEYDOWN:
// use getKey()                 // t_print("Key:%d mod:%d \n", event.key.keysym.sym, event.key.keysym.mod);
// use getKey()                 nWaitInNanoSec =  50000000;
// use getKey()                 
// use getKey()                 // t_print("event.key.state %d\n", event.key.state);
// use getKey() 
// use getKey()                 // HANDLE QUIT
// use getKey()                 if (event.key.keysym.sym == SDLK_ESCAPE ||
// use getKey()                     event.key.keysym.sym == SDLK_q || 
// use getKey()                     event.key.keysym.sym == 'Q')
// use getKey()                 {
// use getKey()                     quit = 1;
// use getKey()                     // nHandleEvents++;
// use getKey()                 }
// use getKey() 
// use getKey()                 // LOUDNESS
// use getKey()                 else if (Global::shiftKey(event) && event.key.keysym.sym == SDLK_DOWN)
// use getKey()                 {
// use getKey()                     // shift down
// use getKey()                     // t_print("leiser\n");
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_LOUDNESS_LOWER));
// use getKey()                 }
// use getKey()                 else if (Global::shiftKey(event) && event.key.keysym.sym == SDLK_UP)
// use getKey()                 {
// use getKey()                     // shift up
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_LOUDNESS_HIGHER));
// use getKey()                 }
// use getKey() 
// use getKey()                 else if (Global::shiftKey(event) && event.key.keysym.sym == SDLK_LEFT)
// use getKey()                 {
// use getKey()                     // shift left
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_JUMP_BACKWARD, 10.0));
// use getKey()                 }
// use getKey() 
// use getKey()                 else if (Global::shiftKey(event) && event.key.keysym.sym == SDLK_RIGHT)
// use getKey()                 {
// use getKey()                     // shift right
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_JUMP_FORWARD, 10.0));
// use getKey()                 }
// use getKey() 
// use getKey()                 // 
// use getKey()                 else if (event.key.keysym.sym == SDLK_n ||
// use getKey()                          event.key.keysym.sym == 'N')
// use getKey()                 {
// use getKey()                     // t_print("next\n");
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_PLAY_NEXT));
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == SDLK_DOWN)
// use getKey()                 {
// use getKey()                     // _aView.up();
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == SDLK_UP)
// use getKey()                 {
// use getKey()                     // _aView.down();
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == SDLK_LEFT)
// use getKey()                 {
// use getKey()                     // _aView.changeDir("..", _aView.getCurrentPath());
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == SDLK_RIGHT)
// use getKey()                 {
// use getKey()                     // t_print("Key right\n");
// use getKey()                     // std::string aStr = _aView.getFileName( _aView.getSelectionPos());
// use getKey()                     // if (_aView.isDirectory(aStr) && aStr != "..")
// use getKey()                     // {
// use getKey()                     //     _aView.changeDir(aStr, "");
// use getKey()                     // }
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == SDLK_c)
// use getKey()                 {
// use getKey()                     t_print("Clear\n");
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_CLEAR_LIST));
// use getKey()                 }
// use getKey()                 
// use getKey()                 else if (event.key.keysym.sym == SDLK_RETURN)
// use getKey()                 {
// use getKey()                     // std::string aStr = _aView.getFileName( _aView.getSelectionPos());
// use getKey()                     // if (_aView.isDirectory(aStr))
// use getKey()                     // {
// use getKey()                     //     std::string sLastDirName;
// use getKey()                     //     if (aStr == "..")
// use getKey()                     //     {
// use getKey()                     //         sLastDirName = _aView.getCurrentPath();
// use getKey()                     //     }                        
// use getKey()                     //     _aView.changeDir(aStr, sLastDirName);
// use getKey()                     // }
// use getKey()                     // else
// use getKey()                     // {
// use getKey()                     //     aBackStr = _aView.getCurrentPath() + "/" + aStr;
// use getKey()                     //     quit = 1;
// use getKey()                     // }
// use getKey()                     quit = 1;
// use getKey()                 }
// use getKey()                 else if (event.key.keysym.sym == 'S' ||
// use getKey()                          event.key.keysym.sym == SDLK_s)
// use getKey()                 {
// use getKey()                     // t_print("stop\n");
// use getKey()                     // _aDispatcher.setNewEvent(EventValue(IMM_AUDIO_EVENT_STOP));
// use getKey()                 }
// use getKey()                 nWaitKeyEndprell++;
// use getKey()                 break;
// use getKey()             default:
// use getKey()                 break;
// use getKey()                 nWaitInNanoSec = 100000000;
// use getKey()                 nWaitKeyEndprell = 0;
// use getKey()             }
// use getKey()             // _aView.paintValues();
// use getKey()             // _aView.update();
// use getKey() 
// use getKey()             // _aDispatcher.handleAnEvent();
// use getKey() 
// use getKey()             // t_print("%d\n", nWaitKeyEndprell);
// use getKey()             if (nWaitKeyEndprell == 1)
// use getKey()             {
// use getKey()                 int nWait = 6;
// use getKey()                 while (nWait--)
// use getKey()                 {
// use getKey()                     // t_print("Entprell...\n");
// use getKey()                     struct timespec delay;
// use getKey()                     delay.tv_sec = 0;
// use getKey()                     delay.tv_nsec = nWaitInNanoSec;
// use getKey()                     
// use getKey()                     nanosleep(&delay, 0); // tenth second
// use getKey()                     SDL_PollEvent( &event );
// use getKey()                     if (event.type == SDL_KEYUP)
// use getKey()                     {
// use getKey()                         // t_print("SDL_KEYUP get.\n");
// use getKey()                         nWaitKeyEndprell = 0;
// use getKey()                         break;
// use getKey()                     }
// use getKey()                 }
// use getKey()             }
// use getKey()         }
// use getKey()         while( SDL_PollEvent( &event ) );
// use getKey()     }
// use getKey()     return aBackStr;
// use getKey() }
...
class mySDL
{
    ...
    void screenUpdate();
    void screenUpdate(Point _aPos, Size _aSize);
...
void mySDL::initialize()
{
  if ( SDL_Init(SDL_INIT_VIDEO /* | SDL_INIT_AUDIO */ | SDL_INIT_TIMER ) < 0 )
    ...
    const char* getcwd_result = getcwd (cDirName, sizeof (cDirName));
...
void mySDL::screenUpdate(Point _aPos, Size _aSize)
{
    SDL_Rect drect;
    clipRect(_aPos.x, _aPos.y, _aSize.w, _aSize.h, drect);
    SDL_UpdateRects(m_pDisplay, 1, &drect);
}

// -----------------------------------------------------------------------------

void mySDL::testPrimitives_fixfont()
{
    FixFont a(m_pDisplay);
    Point aPosition = 
        {
            16, 16
        };
    ...
    aSize = a.setChar(" ", aPosition);
    screenUpdate(aPosition, aSize);

    getKey();

    aPosition.x += aSize.w;
    aSize = a.setChar("A", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("B", aPosition);
    screenUpdate(aPosition, aSize);
    aPosition.x += aSize.w;
    aSize = a.setChar("C", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("D", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("E", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("F", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("G", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("H", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("I", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("J", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("K", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("L", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("M", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("N", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("O", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("P", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("Q", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("R", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("S", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("T", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("U", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("V", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("W", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("X", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("Y", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("Z", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("A", aPosition);    
    aPosition.x += aSize.w;
    aSize = a.setChar("B", aPosition);
    ...
    aSize = a.setChar("0", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("1", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("2", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("3", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("4", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("5", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("6", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("7", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("8", aPosition);
    aPosition.x += aSize.w;
    aSize = a.setChar("9", aPosition);
    aPosition.x += aSize.w;
...
//     ny += 16;
    ...
    Size aSize2 = a.setText("DIES IST EIN TEST", aPosition);
    screenUpdate(aPosition, aSize2);
...
//    m_pFont->setUpdate(true);
    ...
    rectangleColor(m_pDisplay, x + 2,y+100,w,w+10,toUint32(Color::white));
    screenUpdate();
    rectangleColor(m_pDisplay, x+50,y+152,x+w,y+152+30,toUint32(Color::white));
    screenUpdate();
...
void mySDL::testPrimitives4()
{
    ...
    // char **xpm;
    // xpm = test_xpm;
    SDL_Surface *pSurface = IMG_ReadXPMFromArray((char**)A_16x16_xpm);
